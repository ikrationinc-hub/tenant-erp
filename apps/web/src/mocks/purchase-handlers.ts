...
const HEADER_FIELDS = fieldDefinitionsResponseSchema.parse({
  ...
  entity: "header",
  fields: [
    { id: "fd-header-purchase-number", fieldKey: "purchaseNumber", label: "Purchase Number", dataType: "text", isMandatory: false, isEditable: false, isSystem: true, sortOrder: 0 },
    { id: "fd-header-division-id", fieldKey: "divisionId", label: "Division", dataType: "select", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 1, optionsSource: "masters:divisions" },
    ...
    { id: "fd-header-supplier-ref-no", fieldKey: "supplierReferenceNo", label: "Supplier Reference No.", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 8 },
    { id: "fd-header-broker-id", fieldKey: "brokerId", label: "Broker", dataType: "select", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 9, optionsSource: "brokers" },
    { id: "fd-header-broker-commission", fieldKey: "brokerCommission", label: "Broker Commission", fieldType: "Currency", dataType: "decimal", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 10 },
    { id: "fd-header-lot-number", fieldKey: "lotNumber", label: "Shipment Lot Number", dataType: "text", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 11 },
    {
      id: "fd-header-container-id",
    ...
    { id: "fd-header-bl-no", fieldKey: "blNo", label: "Bill of Lading No.", dataType: "text", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 13 },
    { id: "fd-header-loading-date", fieldKey: "loadingDate", label: "Loading Date", dataType: "date", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 14 },
    { id: "fd-header-transport-mode-id", fieldKey: "transportModeId", label: "Through", dataType: "select", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 15, optionsSource: "masters:transport-modes" },
    { id: "fd-header-vessel-id", fieldKey: "vesselId", label: "Vessel Name", dataType: "select", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 16, optionsSource: "masters:vessels" },
    { id: "fd-header-voyage-number", fieldKey: "voyageNumber", label: "Voyage Number", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 17 },
    { id: "fd-header-port-of-loading-id", fieldKey: "portOfLoadingId", label: "Port of Loading", dataType: "select", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 18, optionsSource: "masters:ports" },
    { id: "fd-header-port-of-discharge-id", fieldKey: "portOfDischargeId", label: "Port of Discharge", dataType: "select", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 19, optionsSource: "masters:ports" },
    { id: "fd-header-warehouse-id", fieldKey: "warehouseId", label: "Warehouse", dataType: "select", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 20, optionsSource: "masters:warehouses" },
    { id: "fd-header-incoterm-id", fieldKey: "incotermId", label: "Incoterm", dataType: "select", isMandatory: true, isEditable: true, isSystem: false, sortOrder: 21, optionsSource: "masters:incoterms" },
    { id: "fd-header-bill-of-lading", fieldKey: "billOfLading", label: "Bill of Lading", fieldType: "FileUpload", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 23 },
    { id: "fd-header-packing-list", fieldKey: "packingList", label: "Packing List", fieldType: "FileUpload", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 24 },
    { id: "fd-header-certificate-of-origin", fieldKey: "certificateOfOrigin", label: "Certificate of Origin", fieldType: "FileUpload", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 25 },
    { id: "fd-header-other-documents", fieldKey: "otherDocuments", label: "Other Documents", fieldType: "MultiUpload", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 26 },
    { id: "fd-header-other-documents-2", fieldKey: "otherDocuments2", label: "Other Documents 2", fieldType: "MultiUpload", dataType: "text", isMandatory: false, isEditable: true, isSystem: false, sortOrder: 27 },
  ],
});
...
export function updatePurchaseFieldDefinition(
  id: string,
  patch: { label?: string; isVisible?: boolean; isMandatory?: boolean; sortOrder?: number; allowCreate?: boolean },
