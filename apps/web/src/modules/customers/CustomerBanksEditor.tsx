...
import type { CustomerBank } from "@ikration/contracts";

/** Same reasoning as SupplierBanksEditor - "Bank Details" is a repeatable sub-table in the real backend, not a flat field. Exact mirror. */
export function CustomerBanksEditor({
  value,
  onChange,
}: {
  value: CustomerBank[];
  onChange: (next: CustomerBank[]) => void;
}): ReactElement {
