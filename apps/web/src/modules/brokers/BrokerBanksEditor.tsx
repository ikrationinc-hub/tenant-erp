...
import type { BrokerBank } from "@ikration/contracts";

/** Mirrors modules/suppliers/SupplierBanksEditor.tsx exactly - same reasoning as BrokerContactsEditor. */
export function BrokerBanksEditor({
  value,
  onChange,
}: {
  value: BrokerBank[];
  onChange: (next: BrokerBank[]) => void;
}): ReactElement {
