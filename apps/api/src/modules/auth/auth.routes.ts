...
authRouter.post("/logout", scopeResolverMiddleware, enforcePasswordChangeScope, authController.logout);
authRouter.get("/me", scopeResolverMiddleware, enforcePasswordChangeScope, authController.me);
